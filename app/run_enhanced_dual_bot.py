"""Production entry point for Dual Bot with Enhanced AI Expert.
...
factory so AI Expert instances use EnhancedAIExpertStrategy.
"""
...
def _enhanced_make_strategies(symbols: list, config: dict):
    ...
    strategies = []
    if enable_ai:
        from trading.strategies.enhanced_ai_expert_strategy import (
            EnhancedAIExpertStrategy,
        )
        for symbol in symbols:
            strategies.append(EnhancedAIExpertStrategy(
                symbol,
