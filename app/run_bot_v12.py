"""Standalone runner for Adaptive Bot v12. Paper mode is the safe default."""
...
from trading.adaptive_v12 import TradingBot
from trading.indicator_v12 import compute
...
async def main() -> None:
    ...
    logger.info(
        "Adaptive v12 started | mode=%s margin=$%.2f leverage=%dx symbols=%s",
