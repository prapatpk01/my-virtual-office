...
Score 0–8:
  ...
  D  RSI in momentum zone         +2   BUY: 45-65 / SELL: 35-55
...
class MomentumScoreStrategy(BaseStrategy):
    ...
    def __init__(self, symbol: str, params: dict = None):
        ...
        self.rsi_buy_lo      = self.params.get("rsi_buy_lo",       45)
        self.rsi_buy_hi      = self.params.get("rsi_buy_hi",       65)
        self.rsi_sell_lo     = self.params.get("rsi_sell_lo",      35)
        self.rsi_sell_hi     = self.params.get("rsi_sell_hi",      55)
