"""Adaptive Momentum v2 indicator engine for closed 15-minute candles."""
from __future__ import annotations

from typing import Any, Dict, List
import math

ENGINE_SCHEMA = "adaptive-momentum-v2-15m"
...
def compute(candles: List[Any]) -> Dict[str, Any]:
    ...
    hist_flip_up = macd_hist[-1] > 0 and macd_hist[-2] <= 0
    hist_flip_down = macd_hist[-1] < 0 and macd_hist[-2] >= 0
    ...
    return {
        ...
        "macd_hist_flip_up": hist_flip_up, "macd_hist_flip_down": hist_flip_down,
