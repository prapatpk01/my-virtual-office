...
# V3.3.1 Balanced: XAU live trading disabled by default; set XAU_TRADING_ENABLED=true to re-enable after review.
XAU_TRADING_ENABLED = _env_bool("XAU_TRADING_ENABLED", False)
